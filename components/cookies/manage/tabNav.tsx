        ...
        >
          ...
          <TabsContent value="Consent" id="consentTab">
            <div className="">
              ...
              <p className="mb-10 px-6 leading-[1.4]">
                ...
                social media, och for analyzing traffic. We share, with your consent, information to
                our partners in social media, marketing, and analytics. They can then use this data
                in combination with other data that you hae either shared or that they have
          ...
          <TabsContent value="About" id="aboutTab">
            ...
            <p className="mb-12 px-6 leading-[1.4]">
              ...
              strictly necessary for the website to function. For all other cookies we will need

...
/**
 * Attribution to https://github.com/nodejs/nodejs.org/blob/main/scripts/lighthouse/index.mjs
 */
describe("formatLighthouseResults", () => {
  ...
  it("formats preview urls correctly", () => {
    ...
    const expectations = [
      ...
      expect.stringContaining(`[/en/download](${MOCK_VERCEL_PREVIEW_URL}/en/download)`),
    ];
